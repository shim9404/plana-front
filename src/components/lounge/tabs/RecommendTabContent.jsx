...
export const RecommendTabContent = ({ searchQuery }) => {
      ...
      try {
        ...
        if (searchQuery.keyword) {
          response = await axios.get('/api/lounge/plans/search', {
            params: { type: searchQuery.type, keyword: searchQuery.keyword, tab: 'recommend' }
          });
        } else {
          response = await axios.get('/api/lounge/plans/recommend');
        }
