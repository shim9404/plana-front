...
export const LikedTabContent = ({ searchQuery }) => {
      ...
      try {
        ...
        if (searchQuery.keyword) {
          response = await axios.get('/api/lounge/plans/search', {
            params: { type: searchQuery.type, keyword: searchQuery.keyword, tab: 'liked' }
          });
        } else {
          response = await axios.get('/api/lounge/plans/liked');
        }
